...
proto.google.rpc.RetryInfo.prototype.getRetryDelay = function () {
    return (jspb.Message.getWrapperField(this, google_protobuf_duration_pb.Duration, 1));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.rpc.DebugInfo.toObject = function (includeInstance, msg) {
        var f, obj = {
            stackEntriesList: jspb.Message.getField(msg, 1),
...
proto.google.rpc.QuotaFailure.prototype.getViolationsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.rpc.QuotaFailure.Violation, 1));
};
...
proto.google.rpc.BadRequest.prototype.getFieldViolationsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.rpc.BadRequest.FieldViolation, 1));
};
...
proto.google.rpc.Help.prototype.getLinksList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.rpc.Help.Link, 1));
};
