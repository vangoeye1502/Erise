...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Usage.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            rulesList: jspb.Message.toObjectList(msg.getRulesList(), proto.google.api.UsageRule.toObject, includeInstance),
...
proto.google.api.Usage.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(6, f, proto.google.api.UsageRule.serializeBinaryToWriter);
    }
...
proto.google.api.Usage.prototype.getRulesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.UsageRule, 6));
};
