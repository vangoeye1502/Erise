...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Service.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            apisList: jspb.Message.toObjectList(msg.getApisList(), google_protobuf_api_pb.Api.toObject, includeInstance),
            typesList: jspb.Message.toObjectList(msg.getTypesList(), google_protobuf_type_pb.Type.toObject, includeInstance),
            enumsList: jspb.Message.toObjectList(msg.getEnumsList(), google_protobuf_type_pb.Enum.toObject, includeInstance),
            ...
            endpointsList: jspb.Message.toObjectList(msg.getEndpointsList(), google_api_endpoint_pb.Endpoint.toObject, includeInstance),
            control: (f = msg.getControl()) && google_api_control_pb.Control.toObject(includeInstance, f),
            logsList: jspb.Message.toObjectList(msg.getLogsList(), google_api_log_pb.LogDescriptor.toObject, includeInstance),
            metricsList: jspb.Message.toObjectList(msg.getMetricsList(), google_api_metric_pb.MetricDescriptor.toObject, includeInstance),
            monitoredResourcesList: jspb.Message.toObjectList(msg.getMonitoredResourcesList(), google_api_monitored_resource_pb.MonitoredResourceDescriptor.toObject, includeInstance),
...
proto.google.api.Service.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(20, f, google_protobuf_wrappers_pb.UInt32Value.serializeBinaryToWriter);
    }
    f = message.getName();
    if (f.length > 0) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, google_protobuf_api_pb.Api.serializeBinaryToWriter);
    }
    f = message.getTypesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, google_protobuf_type_pb.Type.serializeBinaryToWriter);
    }
    f = message.getEnumsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(5, f, google_protobuf_type_pb.Enum.serializeBinaryToWriter);
    }
    f = message.getDocumentation();
    if (f != null) {
        writer.writeMessage(6, f, google_api_documentation_pb.Documentation.serializeBinaryToWriter);
    }
    f = message.getBackend();
    if (f != null) {
        writer.writeMessage(8, f, google_api_backend_pb.Backend.serializeBinaryToWriter);
    }
    f = message.getHttp();
    if (f != null) {
        writer.writeMessage(9, f, google_api_http_pb.Http.serializeBinaryToWriter);
    }
    f = message.getQuota();
    if (f != null) {
        writer.writeMessage(10, f, google_api_quota_pb.Quota.serializeBinaryToWriter);
    }
    f = message.getAuthentication();
    if (f != null) {
        writer.writeMessage(11, f, google_api_auth_pb.Authentication.serializeBinaryToWriter);
    }
    f = message.getContext();
    if (f != null) {
        writer.writeMessage(12, f, google_api_context_pb.Context.serializeBinaryToWriter);
    }
    f = message.getUsage();
    if (f != null) {
        writer.writeMessage(15, f, google_api_usage_pb.Usage.serializeBinaryToWriter);
    }
    f = message.getEndpointsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(18, f, google_api_endpoint_pb.Endpoint.serializeBinaryToWriter);
    }
    f = message.getControl();
    if (f != null) {
        writer.writeMessage(21, f, google_api_control_pb.Control.serializeBinaryToWriter);
    }
    f = message.getLogsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(23, f, google_api_log_pb.LogDescriptor.serializeBinaryToWriter);
    }
    f = message.getMetricsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(24, f, google_api_metric_pb.MetricDescriptor.serializeBinaryToWriter);
    }
    f = message.getMonitoredResourcesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(25, f, google_api_monitored_resource_pb.MonitoredResourceDescriptor.serializeBinaryToWriter);
    }
    f = message.getLogging();
    if (f != null) {
        writer.writeMessage(27, f, google_api_logging_pb.Logging.serializeBinaryToWriter);
    }
    f = message.getMonitoring();
    if (f != null) {
        writer.writeMessage(28, f, google_api_monitoring_pb.Monitoring.serializeBinaryToWriter);
    }
    f = message.getSystemParameters();
    if (f != null) {
        writer.writeMessage(29, f, google_api_system_parameter_pb.SystemParameters.serializeBinaryToWriter);
    }
    f = message.getSourceInfo();
    if (f != null) {
        writer.writeMessage(37, f, google_api_source_info_pb.SourceInfo.serializeBinaryToWriter);
    }
    f = message.getExperimental();
    if (f != null) {
        writer.writeMessage(101, f, google_api_experimental_experimental_pb.Experimental.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.Service.prototype.getConfigVersion = function () {
    return (jspb.Message.getWrapperField(this, google_protobuf_wrappers_pb.UInt32Value, 20));
};
...
proto.google.api.Service.prototype.getApisList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_protobuf_api_pb.Api, 3));
};
...
proto.google.api.Service.prototype.getTypesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_protobuf_type_pb.Type, 4));
};
...
proto.google.api.Service.prototype.getEnumsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_protobuf_type_pb.Enum, 5));
};
...
proto.google.api.Service.prototype.getDocumentation = function () {
    return (jspb.Message.getWrapperField(this, google_api_documentation_pb.Documentation, 6));
};
...
proto.google.api.Service.prototype.getBackend = function () {
    return (jspb.Message.getWrapperField(this, google_api_backend_pb.Backend, 8));
};
...
proto.google.api.Service.prototype.getHttp = function () {
    return (jspb.Message.getWrapperField(this, google_api_http_pb.Http, 9));
};
...
proto.google.api.Service.prototype.getQuota = function () {
    return (jspb.Message.getWrapperField(this, google_api_quota_pb.Quota, 10));
};
...
proto.google.api.Service.prototype.getAuthentication = function () {
    return (jspb.Message.getWrapperField(this, google_api_auth_pb.Authentication, 11));
};
...
proto.google.api.Service.prototype.getContext = function () {
    return (jspb.Message.getWrapperField(this, google_api_context_pb.Context, 12));
};
...
proto.google.api.Service.prototype.getUsage = function () {
    return (jspb.Message.getWrapperField(this, google_api_usage_pb.Usage, 15));
};
...
proto.google.api.Service.prototype.getEndpointsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_api_endpoint_pb.Endpoint, 18));
};
...
proto.google.api.Service.prototype.getControl = function () {
    return (jspb.Message.getWrapperField(this, google_api_control_pb.Control, 21));
};
...
proto.google.api.Service.prototype.getLogsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_api_log_pb.LogDescriptor, 23));
};
...
proto.google.api.Service.prototype.getMetricsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_api_metric_pb.MetricDescriptor, 24));
};
...
proto.google.api.Service.prototype.getMonitoredResourcesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_api_monitored_resource_pb.MonitoredResourceDescriptor, 25));
};
...
proto.google.api.Service.prototype.getLogging = function () {
    return (jspb.Message.getWrapperField(this, google_api_logging_pb.Logging, 27));
};
...
proto.google.api.Service.prototype.getMonitoring = function () {
    return (jspb.Message.getWrapperField(this, google_api_monitoring_pb.Monitoring, 28));
};
...
proto.google.api.Service.prototype.getSystemParameters = function () {
    return (jspb.Message.getWrapperField(this, google_api_system_parameter_pb.SystemParameters, 29));
};
...
proto.google.api.Service.prototype.getSourceInfo = function () {
    return (jspb.Message.getWrapperField(this, google_api_source_info_pb.SourceInfo, 37));
};
...
proto.google.api.Service.prototype.getExperimental = function () {
    return (jspb.Message.getWrapperField(this, google_api_experimental_experimental_pb.Experimental, 101));
};
