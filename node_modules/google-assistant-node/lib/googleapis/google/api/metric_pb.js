...
proto.google.api.MetricDescriptor.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, google_api_label_pb.LabelDescriptor.serializeBinaryToWriter);
    }
...
proto.google.api.MetricDescriptor.prototype.getLabelsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_api_label_pb.LabelDescriptor, 2));
};
...
//# sourceMappingURL=metric_pb.js.map