...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.ConfigChange.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            advicesList: jspb.Message.toObjectList(msg.getAdvicesList(), proto.google.api.Advice.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.ConfigChange.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(5, f, proto.google.api.Advice.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.ConfigChange.prototype.getAdvicesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.Advice, 5));
};
...
//# sourceMappingURL=config_change_pb.js.map