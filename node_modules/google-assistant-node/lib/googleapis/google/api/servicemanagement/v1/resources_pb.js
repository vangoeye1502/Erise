...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.servicemanagement.v1.OperationMetadata.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            stepsList: jspb.Message.toObjectList(msg.getStepsList(), proto.google.api.servicemanagement.v1.OperationMetadata.Step.toObject, includeInstance),
...
proto.google.api.servicemanagement.v1.OperationMetadata.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.google.api.servicemanagement.v1.OperationMetadata.Step.serializeBinaryToWriter);
    }
...
proto.google.api.servicemanagement.v1.OperationMetadata.prototype.getStepsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.servicemanagement.v1.OperationMetadata.Step, 2));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.servicemanagement.v1.ConfigSource.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            filesList: jspb.Message.toObjectList(msg.getFilesList(), proto.google.api.servicemanagement.v1.ConfigFile.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.google.api.servicemanagement.v1.ConfigSource.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.google.api.servicemanagement.v1.ConfigFile.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.servicemanagement.v1.ConfigSource.prototype.getFilesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.servicemanagement.v1.ConfigFile, 2));
};
...
proto.google.api.servicemanagement.v1.ConfigFile.prototype.getFileContents_asB64 = function () {
    return (jspb.Message.bytesAsB64(this.getFileContents()));
};
/**
 * optional bytes file_contents = 3;
...
proto.google.api.servicemanagement.v1.ConfigFile.prototype.getFileContents_asU8 = function () {
    return (jspb.Message.bytesAsU8(this.getFileContents()));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.servicemanagement.v1.ChangeReport.toObject = function (includeInstance, msg) {
        var f, obj = {
            configChangesList: jspb.Message.toObjectList(msg.getConfigChangesList(), google_api_config_change_pb.ConfigChange.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.google.api.servicemanagement.v1.ChangeReport.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, google_api_config_change_pb.ConfigChange.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.servicemanagement.v1.ChangeReport.prototype.getConfigChangesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_api_config_change_pb.ConfigChange, 1));
};
...
proto.google.api.servicemanagement.v1.Rollout.prototype.getStrategyCase = function () {
    return (jspb.Message.computeOneofCase(this, proto.google.api.servicemanagement.v1.Rollout.oneofGroups_[0]));
};
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
...
proto.google.api.servicemanagement.v1.Rollout.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(5, f, proto.google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy.serializeBinaryToWriter);
    }
    f = message.getDeleteServiceStrategy();
    if (f != null) {
        writer.writeMessage(200, f, proto.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy.serializeBinaryToWriter);
    }
    f = message.getServiceName();
    if (f.length > 0) {
...
proto.google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy.prototype.getPercentagesMap = function (opt_noLazyCreate) {
    return (jspb.Message.getMapField(this, 1, opt_noLazyCreate, null));
};
...
proto.google.api.servicemanagement.v1.Rollout.prototype.getCreateTime = function () {
    return (jspb.Message.getWrapperField(this, google_protobuf_timestamp_pb.Timestamp, 2));
};
/** @param {?proto.google.protobuf.Timestamp|undefined} value */
...
proto.google.api.servicemanagement.v1.Rollout.prototype.getTrafficPercentStrategy = function () {
    return (jspb.Message.getWrapperField(this, proto.google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy, 5));
};
...
proto.google.api.servicemanagement.v1.Rollout.prototype.getDeleteServiceStrategy = function () {
    return (jspb.Message.getWrapperField(this, proto.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy, 200));
};
