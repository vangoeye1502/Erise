...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Authentication.toObject = function (includeInstance, msg) {
        var f, obj = {
            rulesList: jspb.Message.toObjectList(msg.getRulesList(), proto.google.api.AuthenticationRule.toObject, includeInstance),
            providersList: jspb.Message.toObjectList(msg.getProvidersList(), proto.google.api.AuthProvider.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.Authentication.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.google.api.AuthenticationRule.serializeBinaryToWriter);
    }
    f = message.getProvidersList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, proto.google.api.AuthProvider.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.Authentication.prototype.getRulesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.AuthenticationRule, 3));
};
...
proto.google.api.Authentication.prototype.getProvidersList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.AuthProvider, 4));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.AuthenticationRule.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            requirementsList: jspb.Message.toObjectList(msg.getRequirementsList(), proto.google.api.AuthRequirement.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.google.api.AuthenticationRule.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getOauth();
    if (f != null) {
        writer.writeMessage(2, f, proto.google.api.OAuthRequirements.serializeBinaryToWriter);
    }
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(7, f, proto.google.api.AuthRequirement.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.AuthenticationRule.prototype.getOauth = function () {
    return (jspb.Message.getWrapperField(this, proto.google.api.OAuthRequirements, 2));
};
...
proto.google.api.AuthenticationRule.prototype.getRequirementsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.AuthRequirement, 7));
};
