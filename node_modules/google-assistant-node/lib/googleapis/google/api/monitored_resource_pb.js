...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.MonitoredResourceDescriptor.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            labelsList: jspb.Message.toObjectList(msg.getLabelsList(), google_api_label_pb.LabelDescriptor.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.MonitoredResourceDescriptor.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, google_api_label_pb.LabelDescriptor.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.MonitoredResourceDescriptor.prototype.getLabelsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_api_label_pb.LabelDescriptor, 4));
};
...
//# sourceMappingURL=monitored_resource_pb.js.map