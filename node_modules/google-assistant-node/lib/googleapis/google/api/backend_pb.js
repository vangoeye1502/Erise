...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Backend.toObject = function (includeInstance, msg) {
        var f, obj = {
            rulesList: jspb.Message.toObjectList(msg.getRulesList(), proto.google.api.BackendRule.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.Backend.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.google.api.BackendRule.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.Backend.prototype.getRulesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.BackendRule, 1));
};
...
//# sourceMappingURL=backend_pb.js.map