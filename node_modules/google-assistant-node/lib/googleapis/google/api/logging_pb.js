...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Logging.toObject = function (includeInstance, msg) {
        var f, obj = {
            producerDestinationsList: jspb.Message.toObjectList(msg.getProducerDestinationsList(), proto.google.api.Logging.LoggingDestination.toObject, includeInstance),
            consumerDestinationsList: jspb.Message.toObjectList(msg.getConsumerDestinationsList(), proto.google.api.Logging.LoggingDestination.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.Logging.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.google.api.Logging.LoggingDestination.serializeBinaryToWriter);
    }
    f = message.getConsumerDestinationsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.google.api.Logging.LoggingDestination.serializeBinaryToWriter);
    }
};
/**
 * Generated by JsPbCodeGenerator.
...
proto.google.api.Logging.prototype.getProducerDestinationsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.Logging.LoggingDestination, 1));
};
...
proto.google.api.Logging.prototype.getConsumerDestinationsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.Logging.LoggingDestination, 2));
};
/** @param {!Array.<!proto.google.api.Logging.LoggingDestination>} value */
...
//# sourceMappingURL=logging_pb.js.map