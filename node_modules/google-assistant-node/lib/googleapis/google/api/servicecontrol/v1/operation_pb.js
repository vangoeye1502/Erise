...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.servicecontrol.v1.Operation.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            metricValueSetsList: jspb.Message.toObjectList(msg.getMetricValueSetsList(), google_api_servicecontrol_v1_metric_value_pb.MetricValueSet.toObject, includeInstance),
            logEntriesList: jspb.Message.toObjectList(msg.getLogEntriesList(), google_api_servicecontrol_v1_log_entry_pb.LogEntry.toObject, includeInstance),
...
proto.google.api.servicecontrol.v1.Operation.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(7, f, google_api_servicecontrol_v1_metric_value_pb.MetricValueSet.serializeBinaryToWriter);
    }
    f = message.getLogEntriesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(8, f, google_api_servicecontrol_v1_log_entry_pb.LogEntry.serializeBinaryToWriter);
    }
...
proto.google.api.servicecontrol.v1.Operation.prototype.getEndTime = function () {
    return (jspb.Message.getWrapperField(this, google_protobuf_timestamp_pb.Timestamp, 5));
};
/** @param {?proto.google.protobuf.Timestamp|undefined} value */
...
proto.google.api.servicecontrol.v1.Operation.prototype.getLabelsMap = function (opt_noLazyCreate) {
    return (jspb.Message.getMapField(this, 6, opt_noLazyCreate, null));
};
...
proto.google.api.servicecontrol.v1.Operation.prototype.getMetricValueSetsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_api_servicecontrol_v1_metric_value_pb.MetricValueSet, 7));
};
...
proto.google.api.servicecontrol.v1.Operation.prototype.getLogEntriesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_api_servicecontrol_v1_log_entry_pb.LogEntry, 8));
};
...
//# sourceMappingURL=operation_pb.js.map