...
proto.google.api.servicecontrol.v1.LogEntry.prototype.getPayloadCase = function () {
    return (jspb.Message.computeOneofCase(this, proto.google.api.servicecontrol.v1.LogEntry.oneofGroups_[0]));
};
...
proto.google.api.servicecontrol.v1.LogEntry.prototype.getTimestamp = function () {
    return (jspb.Message.getWrapperField(this, google_protobuf_timestamp_pb.Timestamp, 11));
};
...
proto.google.api.servicecontrol.v1.LogEntry.prototype.getLabelsMap = function (opt_noLazyCreate) {
    return (jspb.Message.getMapField(this, 13, opt_noLazyCreate, null));
};
...
proto.google.api.servicecontrol.v1.LogEntry.prototype.getStructPayload = function () {
    return (jspb.Message.getWrapperField(this, google_protobuf_struct_pb.Struct, 6));
};
...
//# sourceMappingURL=log_entry_pb.js.map