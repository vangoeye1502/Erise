...
proto.google.api.Distribution.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getRange();
    if (f != null) {
        writer.writeMessage(4, f, proto.google.api.Distribution.Range.serializeBinaryToWriter);
    }
    f = message.getBucketOptions();
    if (f != null) {
        writer.writeMessage(6, f, proto.google.api.Distribution.BucketOptions.serializeBinaryToWriter);
    }
...
proto.google.api.Distribution.BucketOptions.prototype.getOptionsCase = function () {
    return (jspb.Message.computeOneofCase(this, proto.google.api.Distribution.BucketOptions.oneofGroups_[0]));
};
if (jspb.Message.GENERATE_TO_OBJECT) {
    /**
     * Creates an object representation of this proto suitable for use in Soy templates.
...
proto.google.api.Distribution.BucketOptions.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.google.api.Distribution.BucketOptions.Linear.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(3, f, proto.google.api.Distribution.BucketOptions.Explicit.serializeBinaryToWriter);
    }
};
/**
 * Generated by JsPbCodeGenerator.
...
proto.google.api.Distribution.BucketOptions.prototype.getLinearBuckets = function () {
    return (jspb.Message.getWrapperField(this, proto.google.api.Distribution.BucketOptions.Linear, 1));
};
...
proto.google.api.Distribution.BucketOptions.prototype.getExponentialBuckets = function () {
    return (jspb.Message.getWrapperField(this, proto.google.api.Distribution.BucketOptions.Exponential, 2));
};
...
proto.google.api.Distribution.BucketOptions.prototype.getExplicitBuckets = function () {
    return (jspb.Message.getWrapperField(this, proto.google.api.Distribution.BucketOptions.Explicit, 3));
};
...
proto.google.api.Distribution.prototype.getRange = function () {
    return (jspb.Message.getWrapperField(this, proto.google.api.Distribution.Range, 4));
};
...
proto.google.api.Distribution.prototype.getBucketOptions = function () {
    return (jspb.Message.getWrapperField(this, proto.google.api.Distribution.BucketOptions, 6));
};
