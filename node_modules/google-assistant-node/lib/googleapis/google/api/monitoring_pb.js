...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Monitoring.toObject = function (includeInstance, msg) {
        var f, obj = {
            producerDestinationsList: jspb.Message.toObjectList(msg.getProducerDestinationsList(), proto.google.api.Monitoring.MonitoringDestination.toObject, includeInstance),
            consumerDestinationsList: jspb.Message.toObjectList(msg.getConsumerDestinationsList(), proto.google.api.Monitoring.MonitoringDestination.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.Monitoring.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.google.api.Monitoring.MonitoringDestination.serializeBinaryToWriter);
    }
    f = message.getConsumerDestinationsList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.google.api.Monitoring.MonitoringDestination.serializeBinaryToWriter);
    }
};
/**
 * Generated by JsPbCodeGenerator.
...
proto.google.api.Monitoring.prototype.getProducerDestinationsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.Monitoring.MonitoringDestination, 1));
};
...
proto.google.api.Monitoring.prototype.getConsumerDestinationsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.Monitoring.MonitoringDestination, 2));
};
/** @param {!Array.<!proto.google.api.Monitoring.MonitoringDestination>} value */
...
//# sourceMappingURL=monitoring_pb.js.map