...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Documentation.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            pagesList: jspb.Message.toObjectList(msg.getPagesList(), proto.google.api.Page.toObject, includeInstance),
            rulesList: jspb.Message.toObjectList(msg.getRulesList(), proto.google.api.DocumentationRule.toObject, includeInstance),
...
proto.google.api.Documentation.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(5, f, proto.google.api.Page.serializeBinaryToWriter);
    }
    f = message.getRulesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.google.api.DocumentationRule.serializeBinaryToWriter);
    }
...
proto.google.api.Documentation.prototype.getPagesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.Page, 5));
};
...
proto.google.api.Documentation.prototype.getRulesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.DocumentationRule, 3));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Page.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            subpagesList: jspb.Message.toObjectList(msg.getSubpagesList(), proto.google.api.Page.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.google.api.Page.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.google.api.Page.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.Page.prototype.getSubpagesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.Page, 3));
};
/** @param {!Array.<!proto.google.api.Page>} value */
...
//# sourceMappingURL=documentation_pb.js.map