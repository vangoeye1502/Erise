...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Billing.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            rulesList: jspb.Message.toObjectList(msg.getRulesList(), proto.google.api.BillingStatusRule.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.Billing.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(5, f, proto.google.api.BillingStatusRule.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.Billing.prototype.getRulesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.BillingStatusRule, 5));
};
...
//# sourceMappingURL=billing_pb.js.map