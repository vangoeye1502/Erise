...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.ProjectProperties.toObject = function (includeInstance, msg) {
        var f, obj = {
            propertiesList: jspb.Message.toObjectList(msg.getPropertiesList(), proto.google.api.Property.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.ProjectProperties.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.google.api.Property.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.ProjectProperties.prototype.getPropertiesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.Property, 1));
};
...
//# sourceMappingURL=consumer_pb.js.map