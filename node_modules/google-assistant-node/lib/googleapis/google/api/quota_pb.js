...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Quota.toObject = function (includeInstance, msg) {
        var f, obj = {
            limitsList: jspb.Message.toObjectList(msg.getLimitsList(), proto.google.api.QuotaLimit.toObject, includeInstance),
            metricRulesList: jspb.Message.toObjectList(msg.getMetricRulesList(), proto.google.api.MetricRule.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.Quota.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.google.api.QuotaLimit.serializeBinaryToWriter);
    }
    f = message.getMetricRulesList();
    if (f.length > 0) {
        writer.writeRepeatedMessage(4, f, proto.google.api.MetricRule.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.Quota.prototype.getLimitsList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.QuotaLimit, 3));
};
...
proto.google.api.Quota.prototype.getMetricRulesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.MetricRule, 4));
};
...
proto.google.api.QuotaLimit.prototype.getValuesMap = function (opt_noLazyCreate) {
    return (jspb.Message.getMapField(this, 10, opt_noLazyCreate, null));
};
...
//# sourceMappingURL=quota_pb.js.map