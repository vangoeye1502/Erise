...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.Context.toObject = function (includeInstance, msg) {
        var f, obj = {
            rulesList: jspb.Message.toObjectList(msg.getRulesList(), proto.google.api.ContextRule.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.Context.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.google.api.ContextRule.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.Context.prototype.getRulesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.ContextRule, 1));
};
