...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.SystemParameters.toObject = function (includeInstance, msg) {
        var f, obj = {
            rulesList: jspb.Message.toObjectList(msg.getRulesList(), proto.google.api.SystemParameterRule.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.SystemParameters.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(1, f, proto.google.api.SystemParameterRule.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.SystemParameters.prototype.getRulesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.SystemParameterRule, 1));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.SystemParameterRule.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            parametersList: jspb.Message.toObjectList(msg.getParametersList(), proto.google.api.SystemParameter.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.google.api.SystemParameterRule.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(2, f, proto.google.api.SystemParameter.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.SystemParameterRule.prototype.getParametersList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, proto.google.api.SystemParameter, 2));
};
...
//# sourceMappingURL=system_parameter_pb.js.map