...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.google.api.SourceInfo.toObject = function (includeInstance, msg) {
        var f, obj = {
            sourceFilesList: jspb.Message.toObjectList(msg.getSourceFilesList(), google_protobuf_any_pb.Any.toObject, includeInstance)
        };
        if (includeInstance) {
...
proto.google.api.SourceInfo.prototype.getSourceFilesList = function () {
    return (jspb.Message.getRepeatedWrapperField(this, google_protobuf_any_pb.Any, 1));
};
...
//# sourceMappingURL=source_info_pb.js.map