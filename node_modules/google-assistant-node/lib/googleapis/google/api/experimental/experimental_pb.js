...
proto.google.api.Experimental.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(8, f, google_api_experimental_authorization_config_pb.AuthorizationConfig.serializeBinaryToWriter);
    }
};
/**
...
proto.google.api.Experimental.prototype.getAuthorization = function () {
    return (jspb.Message.getWrapperField(this, google_api_experimental_authorization_config_pb.AuthorizationConfig, 8));
};
...
//# sourceMappingURL=experimental_pb.js.map